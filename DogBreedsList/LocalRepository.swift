...
class LocalRepository: CoreDataRepository {
...
//
//    func getAllDogs(completion: @escaping (Result<[Cats], ErrorAPI>) throws -> Void) throws {
...
//    }
//
//    func saveDog(with newCat: Cats, catImage: Data, completion: @escaping ((Result<Void, APIError>) -> Void)) {
//
